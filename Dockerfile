FROM ubuntu:14.04
MAINTAINER DeAndre Johnson <dre@phreshr.com>
...
# Basic Requirements
RUN apt-get -y install mysql-server mysql-client nginx php5-fpm php5-mysql php-apc pwgen python-setuptools curl git unzip openssh-server openssl git vim
